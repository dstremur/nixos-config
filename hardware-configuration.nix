...

{
  ...
  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/4EC1-F56C";
      fsType = "vfat";
  ...
  # networking.interfaces.enp11s0f0np0.useDHCP = lib.mkDefault true;
  # networking.interfaces.enp11s0f1np1.useDHCP = lib.mkDefault true;
